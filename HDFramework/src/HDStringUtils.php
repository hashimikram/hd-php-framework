...
class HDStringUtils
{
    ...
    /**
     * Checks if 2 strings are equivalent baring accents.
     *
     * @param string $str1
     *            first string
     * @param string $str2
     ...
     *            nationality for accent translation
     * @return boolean true if the strings are equivalent after the accents are removed, false otherwise
     */
    public static function equalsIgnoreAccents($str1, $str2, $nationality)
    {
        if (strcmp($str1, $str2) == 0) {
            return true;
        }

        if (strcmp(self::removeAccents($str1, $nationality), self::removeAccents($str1, $nationality)) == 0) {
            return true;
        }

        if (strcasecmp('us', $nationality) != 0) {
            // try also without nationality-specific mappings
            if (strcmp(self::removeAccents($str1, $nationality), self::removeAccents($str1, $nationality)) == 0) {
                return true;
            }
        }
     ...
     * @param string $nationality
     *            nationality taken into account for locale specific replacements
     * @return string Filtered string with replaced "nice" characters.
     */
    public static function removeAccents($string, $nationality = 'us')
    {
        ...
        if (self::seems_utf8($string)) {
            ...
            if ('de' == $nationality) {
                ...
                $chars['Å'] = 'Aa';
                $chars['å'] = 'aa';
            } elseif ('ca' === $nationality) {
                $chars['l·l'] = 'll';
            } elseif ('sr' === $nationality || 'bs' === $nationality) {
                $chars['Đ'] = 'DJ';
                $chars['đ'] = 'dj';
            }
